    ...
    <section className={styles.container}>
      <div className={styles.helper}>
        ...
        <div className={styles.sectionSubTitles}>
          <h1 className={styles.title}>SQT® Bio Mikrotűs kezelés</h1>
          <p>
            A szivacstű a Spongilla nemzetségbe tartozó édesvízi
            szivacsokból származik. Ezeket a szivacsokat régóta
            alkalmazzák az alternatív gyógyászatban és kozmetikai célokra.
            A szivacsokat liofilizált eljárással szárítják, sterilizálják,
            őrlik porrá, majd kozmetikai kezelésben használják fel.
          </p>
          <Abstract />
        </div>
        ...
        <div className={styles.sectionSubTitles}>
          ...
          <ul>
            <li>
              Nincs szükség érzéstelenítésre, és nem jár vérzéssel vagy
              bőrseb kialakulásával.
            </li>
            <li>
              A bőr megújulási ciklusát 28 napról 7-14 napra rövidíti,
              így természetes, biztonságos és hatékony fizikai megújulást
              biztosít.
            </li>
            <li>
              Ideális választás azok számára, akik eddig tartózkodtak
              az invazív tűs eljárásoktól.
            </li>
            <li>
            ...
            <li>
              Az eljárás után a bőr üdébb, feszesebb, egyenletesebb lesz,
              és a pigmentfoltok halványulnak.
            </li>
          </ul>
          <Abstract />
        </div>
        ...
        <div className={styles.sectionSubTitles}>
          <h1 className={styles.title}>
            Milyen bőrtípusoknál alkalmazható?
          </h1>
          <p>
        ...
        <div className={styles.sectionSubTitles}>
          ...
          <ul>
            ...
            <li>Egyéb esetekben már 1-2 alkalom után is látványos eredmény érhető el.</li>
          </ul>
          <Abstract />
        </div>
