...
export default function OneNeedProMikrotus() {
  return (
    <>
      <InovativHeader activePage="1 NEED PRO Mikrotűs kezelés" />
        ...
        <div className={styles.helper}>
          ...
          <div className={styles.sectionSubTitles}>
            ...
            <ul>
              <li>
                {" "}
                Konzultáció: A kezelés előtt egy alapos, teljeskörű
                konzultációra kerül sor, ahol felmérjük a bőr állapotát, kitérve
                az otthon használt kozmetikumokra, napozási szokásokra,
                bőrproblémákra.
              </li>
              <li>
                {" "}
                Előkészítés: A kezelési terület tisztítása + Enzimes peeling.
                Fertőtlenítés után érzéstelenítő krémet alkalmazunk a bőrön,
                ennek segítségével minimalizáljuk a kellemetlenség érzését.
              </li>
              <li>
                {" "}
                A kezelés: A 1NeedPro eszköz apró tűi a bőrbe hatolnak. Legyen
                szó mikrotű – vagy mikroszúrásról, a tűk a sejtmembrán falán
                kezelőfejtől függően, mikrocsatornákat hoznak létre, ami
                serkenti a sejtmegújulás folyamatát, illetve segít a
              ...
              <li>
                {" "}
                Befejező ápolás: Utolsó lépésként, a kezelt területet
                bőrnyugtató termékekkel és fényvédővel ápolom.
              </li>
            </ul>
            <Abstract />
          </div>
